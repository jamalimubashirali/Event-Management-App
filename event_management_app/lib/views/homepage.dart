              ...
              child: Column(
                ...
                children: [
                  ...
                  isLoading || events.isEmpty
                      ? const Center(child: Text("No any event" , style: TextStyle(color: kLightGreen),))
                      : CarouselSlider(
                    options: CarouselOptions(
                      autoPlay: true,
                      autoPlayInterval: const Duration(seconds: 5),
                      aspectRatio: 2.0,  // Adjusted for better fitting
                      viewportFraction: 1.0, // Adjusted for item width
                      enlargeCenterPage: true,
                      scrollDirection: Axis.horizontal,
                    ),
                    items: List.generate(events.length, (index) {
