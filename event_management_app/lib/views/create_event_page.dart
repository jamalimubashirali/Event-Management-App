...
class _CreateEventPageState extends State<CreateEventPage>
  ...
  // To pick date and time from the user
                  ...
                  onPressed: () {
                    if (_nameController.text == "" ||
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            "Event Name, Description, Location, and Date & time are required.",
                          ),
                        ),
                      );
                    } else {
                      uploadEventImage().then((value) => createEvent(
